...
<section class="innner-banner position-relative">
    <picture>
        <img src="public/images/inner-banner.jpg" width="1241" height="406" alt="Policy Page Banner">
    </picture>
...
<section class="policy list">
    ...
    <li>
        ...
        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Please contact us at <a href="mailto:info@spotcast.ae">info@spotcast.ae</a>.</p>
    </li>
</ul>
